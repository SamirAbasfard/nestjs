...
exports.ArticletypeModule = void 0;
const common_1 = require("@nestjs/common");
const articletype_service_1 = require("./articletype.service");
const articletype_controller_1 = require("./articletype.controller");
let ArticletypeModule = class ArticletypeModule {
};
ArticletypeModule = __decorate([
    (0, common_1.Module)({
        controllers: [articletype_controller_1.ArticletypeController],
